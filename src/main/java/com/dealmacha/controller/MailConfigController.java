...
public class MailConfigController {
    ...
    @Autowired
    @Qualifier("mailConfigBusinessDelegate")
    public void setMailConfigBusinessDelegate(final IBusinessDelegate<MailConfigModel, MailConfigContext, IKeyBuilder<String>, String> businessDelegate) {
