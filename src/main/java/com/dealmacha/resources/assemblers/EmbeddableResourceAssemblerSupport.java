...
public abstract class EmbeddableResourceAssemblerSupport<T, D extends ResourceSupport, C> extends ResourceAssemblerSupport<T, D> {
    ...
    public EmbeddableResourceAssemblerSupport(final EntityLinks entityLinks, final RelProvider relProvider, final Class<C> controllerClass,
    ...
    /**
     * Create a wrapped representation of a collection, to be added to the _embedded Resources of the containing resource It relies on the
     * embedded resource being annotated with {@link Relation} and the collection of embedded objects being annotated with
     * {@link JsonUnwrapped} (see {@link BookResource#setEmbeddeds()})
     */
