...
public class Transaction extends AbstractDomain implements java.io.Serializable {
    ...
    public Transaction(final String orderStatus, final String refundStatus, final String targetUrl, final String source, final Users users,
            final String code, final Double amount, final String paymentType, final String transactionFor,
            final String transactionErrorCode, final Double cashbackAmount, final String transactionMerchantErrorCode,
            final String transactionMerchantMsg, final Date createdDate, final Integer transactionCount, final Merchant merchant) {
    ...
    public Transaction(final String orderStatus, final String refundStatus, final String targetUrl, final String source, final Users users,
            final String code, final Double amount, final String paymentType, final String transactionFor,
            final String transactionErrorCode, final String transactionMerchantErrorCode, final String transactionMerchantMsg,
            final Merchant merchant, final Integer transactionCount, final Double cashbackAmount, final Date createdDate,
