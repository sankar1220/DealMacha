...
public class Offers extends AbstractDomain implements java.io.Serializable {
    ...
    public Offers(final String offerName, final Date offerCreatedDate, final String offerDescription, final String offerType,
            final String offerArea, final String offerCommissionAmountType, final String offerSource, final Double offerCommissionAmount,
            final String offerStatus, final String offerCommissionType, final Date offerStartDate, final Date offerEndDate,
            final String targetUrl, final String imageName, final String imageType, final String imageLocation) {
    ...
    @Column(name = "offer_commission_type", nullable = false, length = 45)
